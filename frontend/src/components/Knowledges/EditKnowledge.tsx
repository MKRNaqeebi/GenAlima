...
const EditKnowledge = ({ isOpen, onClose, knowledge }: EditKnowledgeProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-lg max-w-md mx-4 w-full p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">EditKnowledge</h3>
        <p className="text-gray-600 mb-4">This component needs to be converted from Chakra UI to Tailwind CSS.</p>
        <p className="text-sm text-gray-500 mb-4">Data: {JSON.stringify(knowledge?.id || 'N/A')}</p>
        <button
          onClick={onClose}
